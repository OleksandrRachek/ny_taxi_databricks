...
dir_path = f"/Volumes/nyctaxi/00_landing/data_sources/nytaxi_fhv/{formatted_date}"

# Define the full path for the downloaded file
local_path = f"{dir_path}/fhv_tripdata_{formatted_date}.parquet"
...
try:
    ...
    try:
        ...
        url = f"https://d37ci6vzurychx.cloudfront.net/trip-data/fhv_tripdata_{formatted_date}.parquet"
