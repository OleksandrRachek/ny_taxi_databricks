...
df_trips = spark.read.table("nyctaxi.02_silver.green_and_yellow_trips_cleansed").filter(f"pickup_datetime > '{two_months_ago_start}'")
...
df_join_final = (
    df_join_1.join(
        ...
        df_join_1.source_file_name
    )
)

# COMMAND ----------

df_join_final.write.mode("append").saveAsTable("nyctaxi.02_silver.green_and_yellow_trips_enriched")
