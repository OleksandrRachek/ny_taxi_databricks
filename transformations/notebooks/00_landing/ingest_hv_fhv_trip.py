...
dir_path = f"/Volumes/nyctaxi/00_landing/data_sources/nytaxi_hvfhv/{formatted_date}"

# Define the full path for the downloaded file
local_path = f"{dir_path}/fhvhv_tripdata_{formatted_date}.parquet"
...
try:
    ...
    try:
        ...
        url = f"https://d37ci6vzurychx.cloudfront.net/trip-data/fhvhv_tripdata_{formatted_date}.parquet"

        
        #Download the file, create the local directory 
        download_file(url=url,dir_path=dir_path,local_path=local_path)
