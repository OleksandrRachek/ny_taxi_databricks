...
taxi_df = spark.read.format("parquet").load(f"/Volumes/nyctaxi/00_landing/data_sources/nytaxi_green/{formatted_date}")

# COMMAND ----------

#add extra columns - processed_timestamp and file_name

taxi_df = taxi_df.withColumn("taxi_type", lit("green taxi"))
...
taxi_df.write.mode("append").saveAsTable("nyctaxi.01_bronze.green_trips_raw")
