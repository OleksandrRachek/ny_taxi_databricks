...
df_trips = (
    df_trips.
        ...
        groupBy(df_trips.pickup_datetime.cast("date").alias("pickup_date"), df_trips.taxi_type ). 
        agg(
...
df_trips.write.mode("append").saveAsTable("nyctaxi.03_gold.daily_trip_summary_per_taxi_type")
