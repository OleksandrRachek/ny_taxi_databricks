...
df_trips = spark.read.table("nyctaxi.02_silver.green_and_yellow_trips_cleansed")
...
df_join_final.write.mode("overwrite").saveAsTable("nyctaxi.02_silver.green_and_yellow_trips_enriched")
